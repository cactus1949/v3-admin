...
import returnCarDialog from "./returnCarDialog.vue";
import cancelOrderDialog from "./cancelDialog.vue";
...
const returnCarDialogRef = ref(returnCarDialog);
const cancelOrderDialogRef = ref(cancelOrderDialog);
...
// 还车
function returnCar(item: any) {
  returnCarDialogRef.value.openDialog(item);
}

// 取消订单
function cancelOrder(item: any) {
  cancelOrderDialogRef.value.openDialog(item);
}
...
<template>
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-container">
      ...
      >
        ...
        <el-table-column
          ...
          width="150"
        />
        <el-table-column label="实际支付租金" prop="createTime" width="150" />
        <el-table-column label="创建时间" prop="createTime" width="150" />
        <el-table-column fixed="right" label="押金" prop="createTime" />
    ...
    <!-- 还车 -->
    <returnCarDialog ref="returnCarDialogRef" @submit="handleQuery" />

    <!-- 取消 -->
    <cancelOrderDialog ref="cancelOrderDialogRef" @submit="handleQuery" />
  </div>
</template>
